...
struct Vertex {
    ...
    static std::array<VkVertexInputAttributeDescription, 2> getAttributeDescriptions()
    {
        ...
        attributeDescriptions[1].binding = 0; // which binding the per-vertex data comes
        attributeDescriptions[1].location = 2; // location directive of the input in the vertex shader
        attributeDescriptions[1].format = VK_FORMAT_R32G32_SFLOAT; // texCoord is a vec2
...
const std::vector<Vertex> vertices = {
        { {-0.5f, -0.5f}, Color::RED, {1.0f, 0.0f} },
        { {0.5f, -0.5f}, Color::GREEN, {0.0f, 0.0f} },
        { {0.5f, 0.5f}, Color::BLUE, {0.0f, 1.0f } },
        { {-0.5f, 0.5f}, Color::WHITE, {1.0f, 1.0f } }
};
...
private:
    ...
    void updateUniformBuffer(uint32_t currentImage)
    {
        ...
        ubo.proj = glm::perspective(glm::radians(45.0f), (float) swapChainExtent.width / (float) swapChainExtent.height, 0.01f, 10.0f);
